...
filename = 'result/ID3/stat' + '_best_r_' + str(best_depth)
...
filename = 'result/ID3/prediction' + '_bestDepth_' + str(best_depth)
...
filename = 'result/ID3/eval' + '_bestDepth_' + str(best_depth)
