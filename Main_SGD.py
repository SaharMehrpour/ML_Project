...
for r in [0.01,0.001]:
    for epoch in [10,15,20,25]:
        ...
        sgd = SGD.SGD(epochs=epoch,W0=[0]*len(data[0]),r=r)#,gamma0=g0,sigma=sigma,C=C)
...
sgd = SGD.SGD(epochs=best_epoch,W0=[0]*len(data[0]),r=best_r)#,gamma0=best_g0,sigma=best_sigma,C=best_C)
